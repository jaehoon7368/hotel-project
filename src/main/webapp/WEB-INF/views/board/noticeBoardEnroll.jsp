        ...
        <div class="notice">
            <div class="notice-board">
                <div class="notice-head">
                    <span class="btn-tab notice-view" onclick="location.href = '<%= request.getContextPath() %>/board/noticeBoardList'">서비스 공지사항</span>
                    <!-- 관리자만 볼수 있는 작성메뉴 -->
                    <span class="btn-tab notice-enroll" onclick="location.href = '<%= request.getContextPath() %>/board/noticeBoardEnroll';">공지사항 작성</span>
                </div>
