                    ...
                    <form action="<%= request.getContextPath() %>/board/inquiyEnroll" method="post" name="inquiyEnrollFrm">
                        <div>
                            ...
                            <table>
                                ...
                                <tr><td>휴대폰 번호</td></tr>
                                <tr><td><input type="tel" name="phone" class="user-input" placeholder="선택사항 입니다."></td></tr>
                                <tr><td>이메일</td></tr>
                                <tr><td><input type="email" name="email" class="user-input" placeholder="선택사항 입니다."></td></tr>
                                <tr><td>문의내용</td></tr>
                                <tr><td><textarea name="content" id="" cols="110" rows="10" style="resize: none;" class="user-input"  placeholder="문의하실 내용을 10자 이상 입력해주세요"></textarea></td></tr>
