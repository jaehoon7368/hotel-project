                        ...
                        <table>
                            ...
                            <tr>
                                <select name="category" id="">
                                    ...
                                    <option value="예약/결제">예약</option>
                                    <option value="취소/환불">취소/환불</option>
                               		<option value="숙소">숙소</option>
                                	<option value="회원정보">회원정보</option>
                            	</select>
                            <td>제목 : <input type="text" name="title" value="<%= faqBoard.getTitle()%>"></td>
                            </tr>
                            <tr>
                                <td>
                                    내용<textarea name="content" id="" cols="80" rows="30"><%= faqBoard.getContent() %></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
